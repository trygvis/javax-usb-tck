...
/**
 * Topology Test Configuration 3 Limited - Tests Topology Hardware Configuration 3
 * <p>
 * This is a limited version of TopologyTestConfig3.java. This test verifies that 
 * the API can traverse a hierarchical device topology but only for one configuration
...
public class TopologyTestConfig3Limited extends TestCase implements TopologyTests
{

    public TopologyTestConfig3Limited(String name)
    {
        super(name);
    }
    ...
    public void testTopologyConfigThree() throws Exception {
        ...
        for ( int i = 0; i < usbListUsbConfigs.size(); i++ )
        {
            ...
            assertEquals("The active configuration # should now be 1",                        
                         (byte) (1), usbProgramableDevice.getActiveUsbConfigurationNumber()); 
            ...
            if (i==0)                                                                         
                assertTrue("Config #" + (1) + " should be the Active Configuration!",         
