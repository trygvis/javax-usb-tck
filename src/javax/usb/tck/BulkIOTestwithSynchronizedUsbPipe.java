...
public class BulkIOTestwithSynchronizedUsbPipe extends TestCase
{
    ...
    {
        BulkIOTests thisTest = new BulkIOTests(usbDevice, usbPipeListGlobal, endpointType);
        thisTest.testByteArray_BuffersNOTMultiplesOfMaxPacketSize_maxPacketSizeOf64bytes_buffer17bytes_passthrough();
    };
    public void testByteArray_BuffersNOTMultiplesOfMaxPacketSize_maxPacketSizeOf64bytes_buffer66bytes_invertBits()
    {
        BulkIOTests thisTest = new BulkIOTests(usbDevice, usbPipeListGlobal, endpointType);
        thisTest.testByteArray_BuffersNOTMultiplesOfMaxPacketSize_maxPacketSizeOf64bytes_buffer66bytes_invertBits();
    };
    public void testByteArray_BuffersNOTMultiplesOfMaxPacketSize_maxPacketSizeOf64bytes_buffer129bytes_invertAltBits()
    {
        BulkIOTests thisTest = new BulkIOTests(usbDevice, usbPipeListGlobal, endpointType);
        thisTest.testByteArray_BuffersNOTMultiplesOfMaxPacketSize_maxPacketSizeOf64bytes_buffer129bytes_invertAltBits();
    };
    ...
    {
        BulkIOTests thisTest = new BulkIOTests(usbDevice, usbPipeListGlobal, endpointType);
        thisTest.testSingleIRP_BuffersNOTMultiplesOfMaxPacketSize_maxPacketSizeOf64bytes_buffer25bytes_invertBits();
    };
    public void testSingleIRP_BuffersNOTMultiplesOfMaxPacketSize_maxPacketSizeOf64bytes_buffer72bytes_invertAltBits()
    {
        BulkIOTests thisTest = new BulkIOTests(usbDevice, usbPipeListGlobal, endpointType);
        thisTest.testSingleIRP_BuffersNOTMultiplesOfMaxPacketSize_maxPacketSizeOf64bytes_buffer72bytes_invertAltBits();
 
    };
    public void testSingleIRP_BuffersNOTMultiplesOfMaxPacketSize_maxPacketSizeOf64bytes_buffer130bytes_passthrough()
    {
        BulkIOTests thisTest = new BulkIOTests(usbDevice, usbPipeListGlobal, endpointType);
        thisTest.testSingleIRP_BuffersNOTMultiplesOfMaxPacketSize_maxPacketSizeOf64bytes_buffer130bytes_passthrough();
    };
    ...
    {
        BulkIOTests thisTest = new BulkIOTests(usbDevice, usbPipeListGlobal, endpointType);
        thisTest.testIRPListBuffersNOTMultiplesOfMaxPacketSizeOf64bytes();
    };
